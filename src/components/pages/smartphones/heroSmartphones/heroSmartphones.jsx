...
import './heroSmartphones.css'
import galaxys10 from '../../../../assets/galaxys10.png'
        ...
        <div className="heroIphones">
            ...
            <div className="heroiphones__container">
                ...
                className="heroiphones__left">
                    <h2>O ecrã do seu Smartphone partiu?</h2>
                    <h2>O seu Smartphone deixou de funcionar?</h2>
                ...
                className="heroiphones__right">
                    <img src={galaxys10} className="heroSmartphones__img" />
                </motion.div>
                <motion.div
                initial={{opacity:0}}
                animate={{opacity:1}}
