    ...
    return (
        <div> 
          <div className="antesdepois__top">
            ...
            <h2>A necessidade de arranjar o seu Smartphone pode surgir por várias questões. Connosco o arranjo do telemóvel fica á responsabilidade de uma equipa certificada e com experiência em diversos tipos de reparação de Smartphone. Alguns dos mais comuns são:<br></br>
            ...
            Se o seu Smartphone também não tem sido o que esperava ou tem vindo a perder a performance inicial, fale connosco! Na Teleufo damos conta do recado, fazemos diagnóstico na hora, gratuito e sem compromisso!</h2>
            </div>
